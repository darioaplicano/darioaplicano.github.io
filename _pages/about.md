...
<p class="hero-tagline">
  Ingeniero de Operaciones en Inteligencia Artificial (AIOps) en <strong>Telefónica España</strong> con más de 10 años de experiencia en sistemas y datos. Me especializo en el diseño e implementación de <strong>sistemas agénticos</strong>, modelos de Machine Learning y arquitecturas de observabilidad en tiempo real para servicios críticos de vídeo y entretenimiento digital (Movistar Plus+).
</p>

<div class="hero-badges">
  <span class="badge-pillar"><i class="fa-solid fa-briefcase"></i> Telefónica España (TME)</span>
  <span class="badge-pillar"><i class="fa-solid fa-robot"></i> Agentes con LangGraph & MCP</span>
  <span class="badge-pillar"><i class="fa-solid fa-database"></i> ClickHouse & Telemetría Masiva</span>
  <span class="badge-pillar"><i class="fa-solid fa-chalkboard-user"></i> Formador Tecnológico</span>
</div>
...
<div class="cta-banner">
  <p class="cta-text">
    ¿Quieres consultar el detalle cronológico de mi trayectoria laboral y formación académica?
  </p>
  <div class="cta-links">
    <a href="/cv/" class="btn-cta"><i class="fa-solid fa-file-lines mr-1"></i> Ver CV Completo</a>
  </div>
</div>
